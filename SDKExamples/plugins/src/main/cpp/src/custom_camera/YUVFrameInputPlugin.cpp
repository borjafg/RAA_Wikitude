...
Java_com_wikitude_samples_advanced_plugins_input_CustomCameraExtension_initNative(JNIEnv* env, jobject obj)
{
...
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_input_CustomCameraExtension_notifyNewCameraFrameN21(JNIEnv* env, jobject obj, jbyteArray cameraFrame)
{
    int frameSize = -1;
...
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_input_CustomCameraExtension_setDefaultDeviceOrientationLandscape(JNIEnv* env, jobject obj, jboolean isLandscape)
{
    YUVFrameInputPlugin::instance->setDefaultOrientationLandscape(isLandscape);
}

extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_input_CustomCameraExtension_setImageSensorRotation(JNIEnv* env, jobject obj, jint rotation)
{
    YUVFrameInputPlugin::instance->setImageSensorRotation(rotation);
}

extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_input_CustomCameraExtension_setCameraFieldOfView(JNIEnv* env, jobject obj, jdouble fieldOfView)
{
    YUVFrameInputPlugin::instance->setCameraFieldOfView(fieldOfView);
}

extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_advanced_plugins_input_CustomCameraExtension_setFrameSize(JNIEnv* env, jobject obj, jint frameWidth, jint frameHeight)
{
...
void YUVFrameInputPlugin::update(const wikitude::sdk::RecognizedTargetsBucket& recognizedTargetsBucket_) {
    if ( !_jniInitialized ) {
        JavaVMResource vm(pluginJavaVM);
        jclass customCameraActivityClass = vm.env->FindClass("com/wikitude/samples/advanced/plugins/input/CustomCameraExtension");
