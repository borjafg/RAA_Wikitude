...
LOCAL_SRC_FILES := jniHelper.cpp JniRegistration.cpp barcode/BarcodePlugin.cpp face_detection/FaceDetectionPlugin.cpp face_detection/FaceDetectionPluginConnector.cpp custom_camera/YUVFrameInputPlugin.cpp custom_camera/YUVFrameShaderSourceObject.cpp marker_tracking/MarkerTrackingPlugin.cpp simple_input_plugin/SimpleInputPlugin.cpp

LOCAL_STATIC_LIBRARIES += zbar iconv aruco opencv_objdetect opencv_calib3d opencv_imgproc opencv_core tbb z WikitudePlugins
